...
///
public string
StandardOutput { get; private set; }
...
///
/// <remarks>
/// Lines of output from the two streams are not guaranteed to be received interleaved in exactly the same order as they
/// were generated.
/// </remarks>
///
public string
CombinedOutput { get; private set; }
