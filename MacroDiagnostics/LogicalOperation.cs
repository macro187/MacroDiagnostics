...
namespace MacroDiagnostics
{
    ...
    public static class LogicalOperation
    {
        ...
        static readonly string source = Path.GetFileName(Environment.GetCommandLineArgs()[0]);
        ...
        static void TraceEvent(TraceEventType eventType, string format, params object[] args)
        { 
        ...
        class Ender : IDisposable
        {
            readonly string description;
            bool disposed;

            public Ender(string description)
            {
