...
static ProcessExtensionsTests()
{
    ...
    #elif NETCOREAPP2_0
    frameworkMoniker = "netcoreapp2.0";
    #else
...
[TestMethod]
public void
Execute_Returns_Correct_ExitCode()
{
    Assert.AreEqual(
        123,
...
[TestMethod]
public void
ExecuteCaptured_Passes_Arguments_Correctly()
{
...
[TestMethod]
public void
ExecuteCaptured_Captures_CommandLine()
{
...
[TestMethod]
public void
ExecuteCaptured_Captures_Output_Correctly()
{
    var result = ProcessExtensions.ExecuteCaptured(true, true, null, TestExe);
...
[TestMethod]
public void
ExecuteCaptured_Uses_Current_WorkingDirectory_By_Default()
{
...
[TestMethod]
public void
ExecuteCaptured_Uses_Specified_WorkingDirectory()
{
    ...
    var result = ProcessExtensions.ExecuteCaptured(true, true, testWorkingDirectory, TestExe, "workingdirectory");
    Assert.AreEqual(
...
public void
ExecuteCaptured_Relative_WorkingDirectory_Fails()
{
...
[ExpectedException(typeof(ArgumentException))]
public void
ExecuteCaptured_Non_Existent_WorkingDirectory_Fails()
{
